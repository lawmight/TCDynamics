  ...
  return (
    <>
            ...
            <nav className="hidden md:flex items-center space-x-6">
              {navigationItems.map(item => (
                <button
                  ...
                  className="text-foreground/80 hover:text-foreground hover:text-primary transition-colors"
                >
                  {item.label}
                </button>
              ))}
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-50 p-3 bg-primary text-white rounded-full shadow-lg hover:bg-primary-glow transition-all duration-300"
