import { FileText, MessageSquare, BarChart3, Shield, ArrowRight, Zap, Brain, Lock } from "lucide-react";
  ...
  const features = [
    {
      ...
      benefits: ["99.7% de précision", "Traitement en temps réel", "Export vers vos outils"],
      color: "primary",
      delay: "0s"
    },
    {
      ...
      description: "Chatbots intelligents qui comprennent vos clients et résolvent 80% des demandes sans intervention humaine.",
      benefits: ["24h/7j disponible", "Multilingue FR/EN", "Escalade automatique"],
      color: "primary-glow",
      delay: "0.1s"
    },
    {
      ...
      description: "Tableaux de bord en temps réel pour piloter votre entreprise. KPIs automatiques et alertes intelligentes.",
    ...
    },
    {
      ...
      description: "Protection maximale de vos données. Audit automatique de conformité et chiffrement bancaire.",
  ...
  return (
    <section className="relative py-20 lg:py-32 bg-background overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-40">
        ...
        <div className="absolute top-2/3 right-1/4 w-1.5 h-1.5 bg-primary-glow rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-1/3 left-1/2 w-1 h-1 bg-primary rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        ...
        <svg className="absolute inset-0 w-full h-full opacity-5" xmlns="http://www.w3.org/2000/svg">
          ...
          <line x1="20%" y1="16%" x2="50%" y2="33%" stroke="url(#features-gradient)" strokeWidth="1" />
          <line x1="75%" y1="66%" x2="50%" y2="33%" stroke="url(#features-gradient)" strokeWidth="1" />
        </svg>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto fade-in-up-delay-2">
            Solutions d'automatisation conçues spécifiquement pour les TPE/PME françaises. 
            <span className="text-primary-glow"> Conformité garantie, efficacité maximale.</span>
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <div className="text-xs font-mono text-muted-foreground">{feature.subtitle}</div>
              ...
              <div className={`absolute inset-0 bg-gradient-to-br from-${feature.color}/5 to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10`}></div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center bg-card/20 backdrop-blur-sm border border-border rounded-lg p-8 fade-in-up-delay-2">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-sm font-mono text-muted-foreground">DONNÉES SÉCURISÉES EN FRANCE</span>
          </div>
