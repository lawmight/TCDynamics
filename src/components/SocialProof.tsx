...
const SocialProof = () => {
  ...
  const testimonials = [
    {
      quote: "WorkFlowAI a révolutionné notre gestion documentaire. Nous économisons 15h par semaine sur le traitement des factures.",
      author: "Marie Dubois",
      position: "Directrice Administrative",
      company: "TechSolutions Montigny",
      rating: 5,
      image: "https://images.unsplash.com/photo-1494790108755-2616b2e4b4b4?w=64&h=64&fit=crop&crop=face"
    },
    {
      quote: "L'équipe française de WorkFlowAI nous accompagne parfaitement. Le support local fait toute la différence.",
    ...
    {
      quote: "La conformité RGPD était notre priorité. WorkFlowAI respecte parfaitement nos exigences de sécurité.",
      author: "Sophie Leroy",
      position: "DPO",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5" aria-hidden="true">
        <div className="absolute inset-0" style={{
          ...
          <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="social-network" width="60" height="60" patternUnits="userSpaceOnUse">
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Header */}
        <div className={`text-center mb-16 ${isIntersecting ? 'fade-in-up' : 'opacity-0'}`}>
          <Badge variant="outline" className="border-primary/40 text-primary font-mono mb-6">
            Témoignages clients
          </Badge>
          <h2 id="social-proof-title" className="text-4xl md:text-5xl font-bold mb-6 text-gradient">
            Ils nous font confiance
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto font-mono">
            Découvrez comment les entreprises françaises transforment leurs processus avec WorkFlowAI
          </p>
        </div>

        {/* Metrics */}
        <div className={`grid md:grid-cols-3 gap-8 mb-16 stagger-fade ${isIntersecting ? '' : 'opacity-0'}`}>
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-1 mb-4" aria-label={`${testimonial.rating} étoiles sur 5`}>
        ...
        {/* Company Logos */}
        <div className={`mb-16 fade-in-up ${isIntersecting ? '' : 'opacity-0'}`}>
        ...
        {/* Trust Indicators */}
        <div className={`grid md:grid-cols-2 gap-8 stagger-fade ${isIntersecting ? '' : 'opacity-0'}`}>
        ...
        {/* CTA */}
        <div className={`text-center mt-16 fade-in-up ${isIntersecting ? '' : 'opacity-0'}`}>
