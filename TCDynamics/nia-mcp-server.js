...
class NIAServer {
  constructor() {
    ...
    this.apiKey = process.env.NIA_API_KEY || 'nk_lrzAv0SQJE3FNfS2yV52Y0XlnZ7WeI5p';
    this.setupHandlers();
  }
          ...
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                component: {
                  type: 'string',
                  enum: ['frontend', 'backend', 'database', 'infrastructure', 'all'],
                  default: 'all'
                }
              }
            }
  ...
  async getProjectOverview(args = {}) {
    ...
    let overview = {
      ...
      description: 'A modern learning platform with AI-powered personalization, interactive progress tracking, and comprehensive Python education',
      technologies: [
        'Python 3.8+', 'Azure Functions', 'React/TypeScript', 'Vite',
        'Tailwind CSS', 'Azure Cosmos DB', 'OVHcloud Hosting', 'Zoho Mail'
      ]
    };
  ...
  getMimeType(uri) {
    ...
    if (uri.endsWith('.js') || uri.endsWith('.ts') || uri.endsWith('.tsx')) return 'application/javascript';
    return 'text/plain';
  }
