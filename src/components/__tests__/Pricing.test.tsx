...
describe('Pricing Component', () => {
  ...
  it('should show feature comparison', () => {
    ...
    expect(screen.getByText(/Traitement de 50 documents\/mois/i)).toBeInTheDocument()
    expect(screen.getByText(/Traitement de 500 documents\/mois/i)).toBeInTheDocument()
  ...
  it('should display support information', () => {
    ...
    expect(screen.getByText(/Équipe basée à Montigny-le-Bretonneux/i)).toBeInTheDocument()
  })
